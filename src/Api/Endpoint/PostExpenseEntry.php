...
class PostExpenseEntry extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    /**
     ...
     * }
     */
    public function __construct(\Concur\Api\Model\EntryPost $requestBody, array $queryParameters = [])
    {
    ...
    {
        if ($this->body instanceof \Concur\Api\Model\EntryPost) {
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status && mb_strpos($contentType, 'application/json') !== false) {
            throw new \Concur\Api\Exception\PostExpenseEntryBadRequestException();
        }
    }
}
