...
class EntryPost
{
    ...
    /**
     * The code for the expense type. Use "GET /expense/expensegroupconfigurations" to learn the expense type code for expense types that are active for this report's policy.
     *
     * @var string
     */
